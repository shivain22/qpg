 ...
 */
public class QuestionTypeCategoryMasterCriteria implements Serializable, Criteria {
    ...
    public QuestionTypeCategoryMasterCriteria() {
    }

    public QuestionTypeCategoryMasterCriteria(QuestionTypeCategoryMasterCriteria other) {
    ...
    @Override
    public QuestionTypeCategoryMasterCriteria copy() {
        return new QuestionTypeCategoryMasterCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final QuestionTypeCategoryMasterCriteria that = (QuestionTypeCategoryMasterCriteria) o;
        return
