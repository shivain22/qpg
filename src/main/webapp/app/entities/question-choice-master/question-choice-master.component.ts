...
export class QuestionChoiceMasterComponent implements OnInit, OnDestroy {
  questionChoiceMasters?: IQuestionChoiceMaster[];
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.questionChoiceMasterService
      ...
      .subscribe(
        (res: HttpResponse<IQuestionChoiceMaster[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  trackId(index: number, item: IQuestionChoiceMaster): number {
    // eslint-disable-next-line @typescript-eslint/no-unnecessary-type-assertion
    return item.id!;
  }

  registerChangeInQuestionChoiceMasters(): void {
    this.eventSubscriber = this.eventManager.subscribe('questionChoiceMasterListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IQuestionChoiceMaster[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
