...
export class TestEntityComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.testEntityService
      ...
      .subscribe(
        (res: HttpResponse<ITestEntity[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  trackId(index: number, item: ITestEntity): number {
  ...
  registerChangeInTestEntities(): void {
    this.eventSubscriber = this.eventManager.subscribe('testEntityListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: ITestEntity[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
    this.totalItems = Number(headers.get('X-Total-Count'));
    this.page = page;
    if (navigate) {
      this.router.navigate(['/test-entity'], {
        queryParams: {
          page: this.page,
          size: this.itemsPerPage,
