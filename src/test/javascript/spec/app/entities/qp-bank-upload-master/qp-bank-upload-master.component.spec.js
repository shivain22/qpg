...
var qp_bank_upload_master_component_1 = require("app/entities/qp-bank-upload-master/qp-bank-upload-master.component");
...
describe('Component Tests', function () {
    describe('QpBankUploadMaster Management Component', function () {
        var comp;
        var fixture;
        var service;
        beforeEach(function () {
            testing_1.TestBed.configureTestingModule({
                ...
                declarations: [qp_bank_upload_master_component_1.QpBankUploadMasterComponent],
                providers: [
                    {
                ...
                .overrideTemplate(qp_bank_upload_master_component_1.QpBankUploadMasterComponent, '')
                .compileComponents();
            fixture = testing_1.TestBed.createComponent(qp_bank_upload_master_component_1.QpBankUploadMasterComponent);
        ...
        it('Should call load all on init', function () {
            ...
            spyOn(service, 'query').and.returnValue(rxjs_1.of(new http_1.HttpResponse({
                body: [new qp_bank_upload_master_model_1.QpBankUploadMaster(123)],
                headers: headers,
            })));
            // WHEN
            comp.ngOnInit();
            ...
            expect(comp.qpBankUploadMasters && comp.qpBankUploadMasters[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
...
//# sourceMappingURL=qp-bank-upload-master.component.spec.js.map