...
describe('Service Tests', () => {
  describe('TestEntity Service', () => {
    ...
    beforeEach(() => {
      ...
      expectedResult = null;
      injector = getTestBed();
      service = injector.get(TestEntityService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new TestEntity(0, 'image/png', 'AAAAAAA', 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a TestEntity', () => {
        ...
        service.create(new TestEntity()).subscribe(resp => (expectedResult = resp.body));
