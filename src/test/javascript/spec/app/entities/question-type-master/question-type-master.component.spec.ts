...
import { QuestionTypeMasterComponent } from 'app/entities/question-type-master/question-type-master.component';
...
describe('Component Tests', () => {
  describe('QuestionTypeMaster Management Component', () => {
    let comp: QuestionTypeMasterComponent;
    let fixture: ComponentFixture<QuestionTypeMasterComponent>;
    let service: QuestionTypeMasterService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [QpgTestModule],
        declarations: [QuestionTypeMasterComponent],
        providers: [
          {
        ...
        .overrideTemplate(QuestionTypeMasterComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(QuestionTypeMasterComponent);
    ...
    it('Should call load all on init', () => {
      ...
      spyOn(service, 'query').and.returnValue(
        of(
          new HttpResponse({
            body: [new QuestionTypeMaster(123)],
            headers,
          })
        )
      );
