...
describe('Service Tests', () => {
  describe('CategoryMaster Service', () => {
    ...
    let elemDefault: ICategoryMaster;
    ...
    beforeEach(() => {
      ...
      expectedResult = null;
      injector = getTestBed();
      service = injector.get(CategoryMasterService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new CategoryMaster(0, 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a CategoryMaster', () => {
        ...
        service.create(new CategoryMaster()).subscribe(resp => (expectedResult = resp.body));
