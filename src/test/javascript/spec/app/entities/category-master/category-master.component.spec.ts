...
import { CategoryMasterComponent } from 'app/entities/category-master/category-master.component';
...
describe('Component Tests', () => {
  describe('CategoryMaster Management Component', () => {
    let comp: CategoryMasterComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CategoryMasterComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.categoryMasters && comp.categoryMasters[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
