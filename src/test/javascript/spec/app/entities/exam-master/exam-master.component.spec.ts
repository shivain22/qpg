...
import { ExamMasterComponent } from 'app/entities/exam-master/exam-master.component';
...
describe('Component Tests', () => {
  describe('ExamMaster Management Component', () => {
    let comp: ExamMasterComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ExamMasterComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.examMasters && comp.examMasters[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
