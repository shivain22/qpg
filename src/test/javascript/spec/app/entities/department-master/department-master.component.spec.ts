...
import { DepartmentMasterComponent } from 'app/entities/department-master/department-master.component';
...
describe('Component Tests', () => {
  describe('DepartmentMaster Management Component', () => {
    let comp: DepartmentMasterComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(DepartmentMasterComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.departmentMasters && comp.departmentMasters[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
