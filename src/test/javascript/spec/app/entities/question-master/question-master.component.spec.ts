...
import { QuestionMasterComponent } from 'app/entities/question-master/question-master.component';
...
describe('Component Tests', () => {
  describe('QuestionMaster Management Component', () => {
    let comp: QuestionMasterComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(QuestionMasterComponent, '')
        .compileComponents();
